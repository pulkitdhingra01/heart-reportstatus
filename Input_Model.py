...
status = st.sidebar.selectbox(
    'DataStatus', ('Valid Data', 'Invalid Data'))
...
if (gender == "Male"):
    if(agegroup == "Children"):
        if heartrate <= 70 or heartrate >= 100:
...
healthy_result = "All the factors are in normal ranges."
negative_result = "All of the following interval/intervals are out of the desired normal ranges for a healthy person:-"
...
st.markdown("---")
st.write("""Click the button below to view a diagram representing the **ECG intervals**.""")
